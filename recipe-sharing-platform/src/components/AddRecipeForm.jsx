...
function AddRecipeForm({ onAddRecipe }) {
  ...
  return (
  <div className="max-w-xl md:max-w-2xl mx-auto p-4 md:p-6 bg-white rounded-xl shadow-lg mt-6">
  ...
  <form onSubmit={handleSubmit} className="space-y-4">
    <div>
      ...
      <input
        ...
        className="w-full border border-gray-300 rounded-lg p-2 md:p-3 focus:ring-2 focus:ring-blue-500"
      />
    ...
    <div>
      ...
      {ingredients.map((ing, idx) => (
        <input
          ...
          className="w-full border border-gray-300 rounded-lg p-2 mb-2 md:p-3 focus:ring-2 focus:ring-blue-500"
        />
      ))}
    ...
    <button
      type="submit"
      className="bg-blue-500 text-white font-medium px-4 py-2 md:px-6 md:py-3 rounded-lg hover:bg-blue-600 transition"
    >
      Submit Recipe
    </button>
  </form>
